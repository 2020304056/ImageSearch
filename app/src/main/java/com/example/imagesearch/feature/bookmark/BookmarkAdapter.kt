package com.example.imagesearch.feature.bookmark
...
class BookmarkAdapter(var mContext: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ItemViewHolder(binding: ItemBinding) : RecyclerView.ViewHolder(binding.root) {
        var iv_thum_image: ImageView = binding.itemImageview
        var iv_like: ImageView = binding.itemHeartImageview
        var tv_title: TextView = binding.itemTitleTextview
        var tv_datetime: TextView = binding.itemDatetimeTextview
